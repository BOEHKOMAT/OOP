...
public class Main {
    ...
    public static void main(String[] args)
    {
        ...
        while(true)
        {
            ...
            System.out.println("+---------------------------------------+");
            System.out.println("| 4 - сортування машин                  |");
            System.out.println("+---------------------------------------+");
            System.out.println("| 5 - пошук машини                      |");
            System.out.println("+---------------------------------------+");
            System.out.println("| 6 - меню машини                       |");
            System.out.println("+---------------------------------------+");
            System.out.println("| 7 - завантажити базу даних у файл     |");
            System.out.println("+---------------------------------------+");
            System.out.println("| 8 - зчитати дані з файлу              |");
            System.out.println("+---------------------------------------+");
            System.out.println("| 9 - очистити базу даних               |");
            System.out.println("+---------------------------------------+");
            ...
            switch (scanner.nextByte())
            {
                    ...
                    if(string.matches("\\w+"))
                    {
                        ...
                        switch (scanner.nextInt())
                        {
                            case 1:
                                ...
                                {
                                    System.out.println("Неправильний формат, використовуйте лише букви!");
                                ...
                                while(transmission < 1 || transmission >3)
                                {
                ...
                case 4:
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 1 - по назві бренду                   |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 2 - по році випуску                   |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 3 - по кольору                        |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 4 - по максимальній швидкості         |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 5 - по розгону до 100 км/год          |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 6 - по витраті палива у місті         |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 7 - по витраті палива поза містом     |");
                    System.out.println("\t+---------------------------------------+");
                    System.out.println("\t| 8 - по ціні                           |");
                    System.out.println("\t+---------------------------------------+");
                    ...
                    switch(scanner.nextByte())
                    {
                        case 1:
                            ...
                            autoshow.sort(brandComparator);
                            break;
                        case 2:
                            YearComparator yearComparator = new YearComparator();
                            autoshow.sort(yearComparator);
                            break;
                        case 3:
                            ColorComparator colorComparator = new ColorComparator();
                            autoshow.sort(colorComparator);
                            break;
                        case 4:
                            SpeedComparator speedComparator = new SpeedComparator();
                            autoshow.sort(speedComparator);
                            break;
                        case 5:
                            DispersalComparator dispersalComparator = new DispersalComparator();
                            autoshow.sort(dispersalComparator);
                            break;
                        case 6:
                            FuelInComparator fuelInComparator = new FuelInComparator();
                            autoshow.sort(fuelInComparator);
                            break;
                        case 7:
                            FuelOutComparator fuelOutComparator = new FuelOutComparator();
                            autoshow.sort(fuelOutComparator);
                            break;
                        case 8:
                            PriceComparator priceComparator = new PriceComparator();
                            autoshow.sort(priceComparator);
                            break;
                        case 9:
                            break;
                    }
                                                ...
                                                while (!exit3)
                                                {
                                                    ...
                                                    switch (scanner.nextInt())
                                                    {
                                                        ...
                                                        case 5:
                                                            ...
                                                            {
                                                                autoshow.get(id).getCharacters().setTransmission(trans);
                                                            }
                                                            break;
                                                        case 6:
                                                            System.out.println("\t+---------------------------------------+");
                ...
                case 10:
                    System.out.println("Дякую за увагу(!требич)!");
                    System.exit(0);
                    break;
            }
        }
